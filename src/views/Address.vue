<template>
    <div>
            ...
            <div class="addr-list-wrap">
              <div class="addr-list">
                <ul>
                  ...
                  <li class="addr-new">
                    <div class="add-new-inner" @click="addressModalFlag=true">
                      <i class="icon-add">
              ...
              <div class="md-modal modal-msg md-modal-transition" v-bind:class="{'md-show':addressModalFlag}">
                <div class="md-modal-inner">
                  <div class="md-top">
                    <div class="md-title">新增地址</div>
                    <button class="md-close" @click="addressModalFlag=false">Close</button>
                  </div>
                  <div class="md-content">
                    <div class="confirm-tips">
                      <ul>
                        <li class="regi_form_input">
                         <input type="text" tabindex="1" name="username" v-model="userName" class="regi_login_input regi_login_input_left" placeholder="Name" data-type="username">
                        </li>
                        <li class="regi_form_input noMargin">
                         <input type="text" tabindex="2"  name="streetName" v-model="streetName" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="newAddress" >
                        </li>
                        <li class="regi_form_input">
                         <input type="text" tabindex="3" name="tel" v-model="tel" class="regi_login_input regi_login_input_left" placeholder="telphone">
                        </li>
                      </ul>
                    </div>
              ...
              <div class="md-overlay" v-if="addressModalFlag" @click="addressModalFlag=false"></div>
      ...
      <modal :mdShow="isMdShow" @close="closeModal">
        ...
        <div slot="btnGroup">
          <a href="javascript:;" class="btn btn--m" @click="delAddress">Yes</a>
          <a href="javascript:;" class="btn btn--m" @click="isMdShow=false">Cancel</a>
        </div>
      </modal>
      <modal :mdShow="isMdShow2" @close="isMdShow2 = false">
        <p slot="message">
          The address list requires at least one data，you can't delete anymore!
        </p>
        <div slot="btnGroup">
          <a href="javascript:;" class="btn btn--m" @click="isMdShow2 = false">Ok</a>
        </div>
      </modal>
  ...
  import axios from 'axios'
    ...
    export default {
      ...
      methods:{
        ...
        addAddress(){
           axios.post("/users/addAddress",{userName:this.userName,streetName:this.streetName,tel:this.tel}).then(response=>{
